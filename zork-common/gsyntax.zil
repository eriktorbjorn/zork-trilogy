...
<SYNTAX DISENCHANT OBJECT = V-DISENCHANT PRE-DISENCHANT>
...
<SYNTAX EXAMINE ON OBJECT (HELD CARRIED IN-ROOM ON-GROUND MANY)
	= V-LOOK-INSIDE>
<SYNONYM EXAMINE X DESCRIBE WHAT WHATS>
...
%<COND (<==? ,ZORK-NUMBER 2>
        '(HELD CARRIED ON-GROUND IN-ROOM TAKE))
       (ELSE
...
<SYNTAX RUB OBJECT = V-RUB PRE-RUB>
<SYNTAX RUB OBJECT WITH OBJECT = V-RUB PRE-RUB>
...
<SYNTAX SIT IN OBJECT (FIND RMUNGBIT) (IN-ROOM ON-GROUND) = V-SIT>
<SYNTAX SIT ON OBJECT (FIND RMUNGBIT) (IN-ROOM ON-GROUND) = V-SIT>
...
<SYNTAX THROW OBJECT (HELD CARRIED HAVE)
	AT OBJECT (FIND ACTORBIT) (ON-GROUND IN-ROOM) = V-THROW PRE-THROW>
<SYNTAX THROW OBJECT (HELD CARRIED HAVE)
	WITH OBJECT (FIND ACTORBIT) (ON-GROUND IN-ROOM) = V-THROW PRE-THROW>
<SYNTAX THROW OBJECT OBJECT = V-OVERBOARD PRE-PUT>
...
<SYNTAX THROW OBJECT (HELD CARRIED ;HAVE) OFF OBJECT = V-THROW-OFF PRE-PUT>
<SYNTAX THROW OBJECT (HELD CARRIED ;HAVE) OVER OBJECT = V-THROW-OFF PRE-PUT>
