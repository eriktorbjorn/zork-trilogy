...
<OBJECT INFLATED-BOAT
	...
	(DESC "magic boat")
	(FLAGS TAKEBIT BURNBIT VEHBIT OPENBIT SEARCHBIT TRYTAKEBIT)
...
<ROOM KITCHEN
	 ...
	 "Only Santa Claus climbs down chimneys.")
      ...
      (FLAGS RLANDBIT ONBIT SACREDBIT)
      (VALUE 10)
      (GLOBAL WHITE-HOUSE KITCHEN-WINDOW CHIMNEY STAIRS)>
