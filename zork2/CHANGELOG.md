...
* Gave the fuse `TRYTAKEBIT`. Otherwise, "`LIGHT FUSE`" would take the fuse out of the brick, leaving you with no time to put it back. (Wile E. Coyote would have been proud.)
